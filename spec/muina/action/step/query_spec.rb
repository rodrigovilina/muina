...
RSpec.describe Muina::Action::Step::Query do
  describe '.new' do
  ...
  describe '.call' do
    ...
    it 'todo wip 3' do
      instance = Object.new.tap { |obj| obj.define_singleton_method(:to_s) { raise Muina::Error } }
      query = described_class.new(name: :one, step: proc { to_s.to_i + 1 })
      expect(query.call(instance)).to be_a(Muina::Result::Failure)
    end
  end
end
